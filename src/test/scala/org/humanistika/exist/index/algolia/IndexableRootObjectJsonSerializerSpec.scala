...
class IndexableRootObjectJsonSerializerSpec extends Specification { def is = s2"""
  ...
  def e1 = {
    val indexableRootObject = new IndexableRootObject(5, 46, None, None, Seq.empty)
    serializeJson(indexableRootObject) mustEqual """{"objectID":"5/46/0"}"""
  }

  def e2 = {
    val indexableRootObject = new IndexableRootObject(6, 47, Some("1.2.2"), None, Seq.empty)
  ...
  def e3 = {
    ...
    val indexableRootObject = new IndexableRootObject(7, 48, Some("1"), None, attributes)
  ...
  def e4 = {
    ...
    val indexableRootObject = new IndexableRootObject(2, 48, Some("1"), None, attributes)
  ...
  def e5 = {
    ...
    val indexableRootObject = new IndexableRootObject(9, 48, Some("1"), None, attributes)
  ...
  def e6 = {
    ...
    val indexableRootObject = new IndexableRootObject(3, 48, Some("1"), None, attributes)
  ...
  def e8 = {
    ...
    val indexableRootObject = new IndexableRootObject(7, 42, Some("1"), None, attributes)
    serializeJson(indexableRootObject) mustEqual """{"objectID":"7/42/1","xx":[99.9,202.2],"yy":[11.4,10.2]}"""
  }
  ...
  def e9 = {
    ...
    val indexableRootObject = new IndexableRootObject(6, 48, Some("1"), None, attributes)
  ...
  def e12 = {
    ...
    val indexableRootObject = new IndexableRootObject(1, 48, Some("1"), None, attributes)
  ...
  def e14 = {
    ...
    val attributes = Seq(-\/(IndexableAttribute("elem1", Seq(IndexableValue("1.1", -\/(elem1))), LiteralTypeConfig.String)))
    val indexableRootObject = new IndexableRootObject(23, 48, Some("1"), None, attributes)
  ...
  def e15 = {
    ...
    val indexableRootObject = new IndexableRootObject(7, 42, Some("1"), None, attributes)
    serializeJson(indexableRootObject) mustEqual """{"objectID":"7/42/1","xx":[123.4,456.12],"yy":[-17.45,15.67]}"""
  }

  def e16 = {
    val attr1 = attr(dom("""<w value="hello"/>"""), "value")
    val objects = Seq(\/-(IndexableObject("obj1", Seq(IndexableValue("1.1", \/-(attr1))), Map.empty)))
    val indexableRootObject = new IndexableRootObject(45, 48, Some("1"), None, objects)
  ...
  def e17 = {
    ...
    val indexableRootObject = new IndexableRootObject(46, 49, Some("1"), None, objects)
    serializeJson(indexableRootObject) mustEqual """{"objectID":"46/49/1","obj1":["hello","world"]}"""
  }

  def e18 = {
    val elem1 = elem(dom("""<w><x>hello</x><y>world</y></w>"""), "w")
    val objects = Seq(\/-(IndexableObject("obj1", Seq(IndexableValue("1.1", -\/(elem1))), Map.empty)))
    val indexableRootObject = new IndexableRootObject(5, 48, Some("1"), None, objects)
  ...
  def e19 = {
    ...
    val objects = Seq(\/-(IndexableObject("obj1", Seq(IndexableValue("1.1", -\/(elem1))), Map.empty)))
    val indexableRootObject = new IndexableRootObject(2, 48, Some("1"), None, objects)
  ...
  def e20 = {
    ...
    val objects = Seq(\/-(IndexableObject("obj1", Seq(IndexableValue("1.1", -\/(elem1))), Map.empty)))
    val indexableRootObject = new IndexableRootObject(3, 48, Some("1"), None, objects)
  ...
  def e21 = {
    ...
    val objects = Seq(\/-(IndexableObject("obj1", Seq(IndexableValue("1.1", -\/(elem1))), Map.empty)))
    val indexableRootObject = new IndexableRootObject(6, 48, Some("1"), None, objects)
  ...
  def e22 = {
    ...
    val indexableRootObject = new IndexableRootObject(6, 48, Some("1"), None, objects)
    serializeJson(indexableRootObject) mustEqual """{"objectID":"6/48/1","obj1":[{"nodeId":"1.1","x":"hello","y":{"yy":["world","again"]}},{"nodeId":"1.2","x":"goodbye","y":{"yy":["until","next time"]}}]}"""
  }
