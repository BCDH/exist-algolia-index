...
class IndexableRootObjectJsonSerializerSpec extends Specification { def is = s2"""
  ...
  def e1 = {
    val indexableRootObject = new IndexableRootObject(46, None, Seq.empty)
    serializeJson(indexableRootObject) mustEqual """{"docId":46}"""
  }

  def e2 = {
    val indexableRootObject = new IndexableRootObject(47, Some("1.2.2"), Seq.empty)
    serializeJson(indexableRootObject) mustEqual """{"docId":47,"nodeId":"1.2.2"}"""
  }

  def e3 = {
    val attr1 = attr(dom("""<w value="hello"/>"""), "value")
    val attributes = Seq(-\/(IndexableAttribute("attr1", "1.1", \/-(attr1), LiteralTypeConfig.String)))
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","attr1":"hello"}"""
  }
  ...
  def e4 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","attr1":99.9}"""
  }
  ...
  def e5 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","attr1":1012}"""
  }
  ...
  def e6 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","attr1":true}"""
  }
  ...
  def e7 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","attr1":99.9,"attr2":11.4}"""
  }
  ...
  def e8 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","elem1":"hello"}"""
  }
  ...
  def e9 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","elem1":99.9}"""
  }
  ...
  def e10 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","elem1":1012}"""
  }
  ...
  def e11 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","elem1":true}"""
  }
  ...
  def e12 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","elem1":99.9,"elem2":11.3}"""
  }
  ...
  def e13 = {
    ...
    val attributes = Seq(-\/(IndexableAttribute("elem1", "1.1", -\/(elem1), LiteralTypeConfig.String)))
    val indexableRootObject = new IndexableRootObject(48, Some("1"), attributes)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","elem1":"hello world"}"""
  }

  def e14 = {
    val attr1 = attr(dom("""<w value="hello"/>"""), "value")
    val objects = Seq(\/-(IndexableObject("obj1", "1.1", \/-(attr1), Map.empty)))
    val indexableRootObject = new IndexableRootObject(48, Some("1"), objects)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","obj1":"hello"}"""
  }
  ...
  def e15 = {
    ...
    val indexableRootObject = new IndexableRootObject(48, Some("1"), objects)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","obj1":{"nodeId":"1.1","x":"hello","y":"world"}}"""
  }
  ...
  def e16 = {
    ...
    val objects = Seq(\/-(IndexableObject("obj1", "1.1", -\/(elem1), Map.empty)))
    val indexableRootObject = new IndexableRootObject(48, Some("1"), objects)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","obj1":{"nodeId":"1.1","x":"hello","y":{"z":"world","zz":"again"}}}"""
  }
  ...
  def e17 = {
    ...
    val objects = Seq(\/-(IndexableObject("obj1", "1.1", -\/(elem1), Map.empty)))
    val indexableRootObject = new IndexableRootObject(48, Some("1"), objects)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","obj1":{"nodeId":"1.1","x":"hello","y":["world","again"]}}"""
  }
  ...
  def e18 = {
    ...
    val objects = Seq(\/-(IndexableObject("obj1", "1.1", -\/(elem1), Map.empty)))
    val indexableRootObject = new IndexableRootObject(48, Some("1"), objects)
    serializeJson(indexableRootObject) mustEqual """{"docId":48,"nodeId":"1","obj1":{"nodeId":"1.1","x":"hello","y":{"yy":["world","again"]}}}"""
  }
